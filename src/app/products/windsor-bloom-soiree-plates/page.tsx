...
export const metadata: Metadata = {
  title: 'Windsor Bloom Soiree Plates - Mevi Living',
  description: 'Elegant plates from the Serveware collection.',
};

export default function WindsorBloomSoireePlatesPage() {
  const product = getServewareProductBySlug('windsor-bloom-soiree-plates');
  if (!product) notFound();
