...
export const metadata: Metadata = {
  title: 'Alba Trayette - Mevi Living',
  description: 'Elegant Alba Trayette from the Serveware collection.',
};

export default function AlbaTrayPage() {
  const product = getServewareProductBySlug('alba-trayette');
  if (!product) notFound();
