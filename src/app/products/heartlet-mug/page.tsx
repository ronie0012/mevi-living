...
export const metadata: Metadata = {
  ...
  description: "Elegant heart-shaped ceramic mug. A perfect gift for loved ones.",
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="relative aspect-square bg-white rounded-lg overflow-hidden">
              <Image
                src="https://meviliving.com/cdn/shop/files/Heartlet_Mug_4.jpg?v=1751440636&width=800"
                alt="Heartlet Mug - Front View"
                width={800}
                height={800}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative aspect-square bg-white rounded-lg overflow-hidden">
                <Image
                  src="https://meviliving.com/cdn/shop/files/HeartletMug_2.jpg?v=1751440636&width=400"
                  alt="Heartlet Mug - Side View"
                  width={400}
                  height={400}
                  className="w-full h-full object-cover"
                />
              ...
              <div className="relative aspect-square bg-white rounded-lg overflow-hidden">
                <Image
                  src="https://meviliving.com/cdn/shop/files/Heartlet_Mug_4.jpg?v=1751440636&width=400"
                  alt="Heartlet Mug - Detail"
                  width={400}
                  height={400}
                  className="w-full h-full object-cover"
                />
