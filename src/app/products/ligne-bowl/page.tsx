...
export const metadata: Metadata = {
  title: 'Ligne Bowl - Mevi Living',
  description: 'Modern minimalist bowl with clean lines and contemporary design.',
};

export default function LigneBowlPage() {
  const product = getServewareProductBySlug('ligne-bowl');
  if (!product) notFound();
