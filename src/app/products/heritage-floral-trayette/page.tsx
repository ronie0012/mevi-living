...
export const metadata: Metadata = {
  title: 'Heritage Floral Trayette - Mevi Living',
  description: 'Heritage-inspired trayette from the Serveware collection.',
};

export default function HeritageFloralTrayPage() {
  const product = getServewareProductBySlug('heritage-floral-trayette');
  if (!product) notFound();
